...
image_url: "/assets/editorials/say-vs-click.svg"
audio_en: "/assets/editorials/audio/loss-aversion-and-the-news-why-uncertainty-makes-us-crave-ca-en.mp3"
content_nl: |
  # Verliesaversie en het nieuws: waarom onzekerheid ons doet hunkeren naar catastrofe
  
  ![De waardefunctie van de prospecttheorie: een S-vormige curve die veel steiler is onder de oorsprong, wat laat zien dat een verlies groter aanvoelt dan een gelijkwaardige winst](/assets/editorials/prospect-value-function.svg)
  ...
  Ik denk dat het beste antwoord dat ik ooit heb gevonden afkomstig is van twee psychologen wiens werk ik oprecht bewonder, en wiens ideeën precies in het hart zitten van waarom ik [Positron](https://positron.today/) heb gebouwd. Laat me je vertellen over Daniel Kahneman en Amos Tversky, en een prachtig, iets verontrustend idee dat prospecttheorie wordt genoemd.
  
  ## De belangrijkste grafiek die je nooit hebt gezien
  
  In 1979 publiceerden Kahneman en Tversky een paper in het economisch tijdschrift Econometrica genaamd ["Prospect Theory: An Analysis of Decision under Risk"](https://en.wikipedia.org/wiki/Prospect_theory). Het werd een van de meest geciteerde artikelen in de sociale wetenschappen en het leverde Kahneman uiteindelijk een Nobelprijs voor de economie op - wat behoorlijk bijzonder is voor een psycholoog die, zoals hij zelf vrolijk toegeeft, nooit een enkele cursus economie heeft gevolgd.
  ...
  ![Twee panelen: links een persoon die zegt dat ze de voorkeur geven aan positief nieuws, rechts dezelfde persoon die op negatieve koppen klikt](/assets/editorials/say-vs-click.svg)
  ...
  En dit is niet alleen een eigenaardigheid van één lab in één land. In 2019 voerden Soroka, samen met Patrick Fournier en Lilach Nir, een opmerkelijke studie uit in [zeventien landen op zes continenten](https://www.pnas.org/doi/10.1073/pnas.1908369116). Ze verbonden mensen - meetend huidgeleiding en hartslag, de eerlijke kleine signalen van het lichaam - en toonden hen echte nieuwsfragmenten. Gemiddeld, over de hele wereld, waren mensen fysiologisch meer opgewonden door negatief nieuws dan door positief nieuws. Verschillende culturen, verschillende talen, verschillende mediasystemen, dezelfde basis lichamelijke reactie. De aantrekkingskracht van het negatieve is geen Westers mediaprobleem. Het lijkt een onderdeel van het menselijke besturingssysteem te zijn.
...
content_fr: |
  ...
  ![La fonction de valeur de la théorie des perspectives : une courbe en S qui est beaucoup plus raide en dessous de l'origine, montrant qu'une perte semble plus importante qu'un gain équivalent](/assets/editorials/prospect-value-function.svg)
  ...
  Je pense que la meilleure réponse que j'ai jamais trouvée vient de deux psychologues dont j'adore vraiment le travail, et dont les idées se trouvent au cœur même de la raison pour laquelle j'ai construit [Positron](https://positron.today/). Alors laissez-moi vous parler de Daniel Kahneman et Amos Tversky, et d'une idée belle et légèrement troublante appelée la théorie des perspectives.
  
  ## Le graphique le plus important que vous n'avez jamais vu
  
  En 1979, Kahneman et Tversky ont publié un article dans la revue économique Econometrica intitulé ["Théorie des perspectives : une analyse de la décision sous risque"](https://en.wikipedia.org/wiki/Prospect_theory). Cet article est devenu l'un des plus cités dans toutes les sciences sociales, et il a finalement valu à Kahneman un prix Nobel d'économie - ce qui est assez remarquable pour un psychologue qui, de son propre aveu joyeux, n'a jamais suivi un seul cours d'économie.
  ...
  ![Deux panneaux : à gauche une personne disant qu'elle préfère les bonnes nouvelles, à droite la même personne cliquant sur des titres négatifs](/assets/editorials/say-vs-click.svg)
...
![The prospect theory value function: an S-shaped curve that is much steeper below the origin, showing that a loss feels bigger than an equivalent gain](/assets/editorials/prospect-value-function.svg)
...
I think the best answer I've ever found comes from two psychologists whose work I genuinely love, and whose ideas sit right at the heart of why I built [Positron](https://positron.today/). So let me tell you about Daniel Kahneman and Amos Tversky, and a beautiful, slightly unsettling idea called prospect theory.

## The most important graph you've never seen

In 1979, Kahneman and Tversky published a paper in the economics journal Econometrica called ["Prospect Theory: An Analysis of Decision under Risk"](https://en.wikipedia.org/wiki/Prospect_theory). It went on to become one of the most cited papers in all of social science, and it eventually won Kahneman a Nobel Prize in economics - which is quite something for a psychologist who, by his own cheerful admission, never took a single economics course.
...
![Two panels: on the left a person saying they prefer positive news, on the right the same person clicking on negative headlines](/assets/editorials/say-vs-click.svg)
