---
title: "We measured how rare good news actually is. It's worse than you think..."
title_nl: "We hebben gemeten hoe zeldzaam goed nieuws eigenlijk is. Het is erger dan je denkt..."
title_fr: "Nous avons mesuré à quel point les bonnes nouvelles sont rares. C'est pire que vous ne le pensez..."
date: 2026-07-13 05:49:18
emoji: "✍️"
summary: "I recently discovered that sixty-two percent of the days in our data showed no clearly-positive articles from news outlets. This doesn't mean there was no good news at all, but rather that it's so scattered that no single publication consistently shares it. The average positivity score is about 7 percent, but the median is zero, revealing a stark reality. Even dedicated good-news sites only manage to publish uplifting content about half the time, highlighting the challenge of finding positivity in today's news landscape."
summary_nl: "Onlangs ontdekte ik dat tweeënzestig procent van de dagen in onze gegevens geen duidelijk positieve artikelen van nieuwsmedia toonde. Dit betekent niet dat er helemaal geen goed nieuws was, maar eerder dat het zo verspreid is dat geen enkele publicatie het consequent deelt. De gemiddelde positiviteitsscore is ongeveer 7 procent, maar de mediaan is nul, wat een scherpe realiteit onthult. Zelfs toegewijde goede-nieuwssites slagen er maar in om ongeveer de helft van de tijd opbeurende inhoud te publiceren, wat de uitdaging benadrukt om positiviteit in het nieuws van vandaag te vinden."
summary_fr: "J'ai récemment découvert que soixante-deux pour cent des jours dans nos données n'affichaient aucun article clairement positif des médias d'information. Cela ne signifie pas qu'il n'y avait pas de bonnes nouvelles, mais plutôt qu'elles sont si dispersées qu'aucune publication ne les partage de manière cohérente. Le score de positivité moyen est d'environ 7 pour cent, mais la médiane est de zéro, révélant une réalité frappante. Même les sites dédiés aux bonnes nouvelles ne parviennent à publier du contenu positif qu'environ la moitié du temps, soulignant le défi de trouver de la positivité dans le paysage médiatique actuel."
image_url: "/assets/editorials/illustration.png"
audio_en: "/assets/editorials/audio/we-measured-how-rare-good-news-actually-is-its-worse-than-yo-en.mp3"
content_nl: |
  ...
  ![Raster van 100 vierkanten waar 62 grijs zijn en 38 groen. Elk vierkant is één outlet op één dag; 62% had nul duidelijk positieve artikelen](/assets/editorials/illustration.png)
...
content_fr: |
  ...
  ![Grille de 100 carrés où 62 sont gris et 38 sont verts. Chaque carré représente un média un jour ; 62 % n'ont publié aucun article clairement positif](/assets/editorials/illustration.png)
...
![Grid of 100 squares where 62 are grey and 38 are green. Each square is one outlet on one day; 62% carried zero clearly-positive articles](/assets/editorials/illustration.png)
