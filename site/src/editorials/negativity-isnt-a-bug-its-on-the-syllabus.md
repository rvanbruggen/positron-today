---
title: "Negativity isn't a bug, it's on the syllabus"
title_nl: "Negativiteit is geen bug, het staat in het syllabus"
title_fr: "La négativité n'est pas un bug, c'est au programme"
date: 2026-07-27T05:46:01
emoji: "✍️"
summary: "It's fascinating to think about how negativity is woven into the fabric of journalism. Research shows that bad news is simply more newsworthy than good news, and this idea has been formalized in journalism education. No one teaches journalists to be negative, but the criteria for newsworthiness often lead them there. This isn't a fixed rule; it's a convention that can change, and that's the exciting part."
summary_nl: "Het is fascinerend om na te denken over hoe negativiteit in de journalistiek is verweven. Onderzoek toont aan dat slecht nieuws simpelweg nieuwswaardiger is dan goed nieuws, en dit idee is geformaliseerd in de journalistieke opleiding. Niemand leert journalisten om negatief te zijn, maar de criteria voor nieuwswaarde leiden hen vaak daarheen. Dit is geen vaste regel; het is een conventie die kan veranderen, en dat is het spannende eraan."
summary_fr: "Il est fascinant de penser à la façon dont la négativité est tissée dans le tissu du journalisme. Des recherches montrent que les mauvaises nouvelles sont tout simplement plus dignes d'intérêt que les bonnes nouvelles, et cette idée a été formalisée dans l'éducation journalistique. Personne n'enseigne aux journalistes d'être négatifs, mais les critères de valeur d'actualité les y mènent souvent. Ce n'est pas une règle fixe ; c'est une convention qui peut changer, et c'est ce qui est excitant."
image_url: "/assets/editorials/negativity-syllabus-illustration.svg"
content_nl: |
  ...
  ![Een pagina van een journalistiek lesprogramma met klassieke nieuwswaarden - onverwachtheid, nabijheid, prominentie, omvang - met het woord "negativiteit" stilletjes gemarkeerd in amber, en de mantra van de redactiekamer "als het bloedt, leidt het" eronder geschreven.](/assets/editorials/negativity-syllabus-illustration.svg)
  
  Op deze site heb ik eerder geschreven over de twee gebruikelijke verdachten. Er is de hersenen: we zijn zo geprogrammeerd dat [slecht sterker is dan goed](https://positron.today/editorials/bad-is-stronger-than-good-the-psychology-that-keeps-us-readi/), verliezen doen meer pijn dan equivalente winsten, en een enkele nare opmerking overleeft een week van lof. En er is de machine: de [algoritmen die hebben geleerd om ons woede te verkopen](https://positron.today/editorials/five-points-for-anger-how-algorithms-learned-to-sell-us-the/), die een verontwaardigde reactie vijf keer zwaarder wegen dan een like.
  ...
  En daar, op de lijst, tussen "onverwachtheid" en "verwijzing naar elite-naties", staat één woord: **negativiteit**. Slecht nieuws, zegt hun kader eenvoudig, is simpelweg nieuwswaardiger dan goed nieuws. Een tragedie, een ongeluk, een schandaal, een ramp - al deze dingen scoren hoger dan een bruiloft of een herstel of een rustige, saaie succes. Decennia later, toen Tony Harcup en Deirdre O'Neill [de lijst bijwerkten voor het moderne tijdperk](https://www.tandfonline.com/doi/full/10.1080/1461670X.2016.1150193), overleefde "slecht nieuws" de herschrijving intact. Het staat er nog steeds op.
...
content_fr: |
  ...
  ![Une page de programme de journalisme listant les valeurs classiques de l'actualité - imprévisibilité, proximité, notoriété, ampleur - avec le mot "négativité" discrètement mis en évidence en ambre, et le mantra de la salle de rédaction "si ça saigne, ça mène" écrit en dessous.](/assets/editorials/negativity-syllabus-illustration.svg)
  
  Sur ce site, j'ai déjà écrit sur les deux suspects habituels. Il y a le cerveau : nous sommes câblés de sorte que [le mauvais soit plus fort que le bon](https://positron.today/editorials/bad-is-stronger-than-good-the-psychology-that-keeps-us-readi/), les pertes font plus mal que des gains équivalents, et un seul commentaire désagréable survit à une semaine de louanges. Et il y a la machine : les [algorithmes qui ont appris à nous vendre de la colère](https://positron.today/editorials/five-points-for-anger-how-algorithms-learned-to-sell-us-the/), pondérant une réaction indignée cinq fois plus lourdement qu'un "j'aime".
  ...
  Et maintenant la partie que je trouve vraiment délicieuse. Johan Galtung, l'homme dont le nom est attaché à cette liste, a passé ses dernières années [à dire que les médias l'avaient mal compris](https://en.wikipedia.org/wiki/News_values). Il sentait que la profession avait pris son travail et était devenue beaucoup trop négative, trop sensationnelle, trop antagoniste. Il a décrit quelque chose qui *se passait* dans les nouvelles - et a vu cela être traité comme une instruction sur la façon dont les nouvelles *devraient* être.
...
![A journalism syllabus page listing classic news values - unexpectedness, proximity, prominence, magnitude - with the word "negativity" quietly highlighted in amber, and the newsroom mantra "if it bleeds, it leads" written underneath.](/assets/editorials/negativity-syllabus-illustration.svg)

On this site I've written before about the two usual suspects. There's the brain: we're wired so that [bad is stronger than good](https://positron.today/editorials/bad-is-stronger-than-good-the-psychology-that-keeps-us-readi/), losses hurt more than equivalent gains, and a single nasty comment outlives a week of praise. And there's the machine: the [algorithms that learned to sell us anger](https://positron.today/editorials/five-points-for-anger-how-algorithms-learned-to-sell-us-the/), weighting an outraged reaction five times heavier than a like.
...
And now the part I find genuinely delicious. Johan Galtung, the man whose name is attached to that list, spent later years [saying the media had misread him](https://en.wikipedia.org/wiki/News_values). He felt the profession had taken his work and become far too negative, too sensational, too adversarial. He described something that *was* happening in the news - and watched it get treated as an instruction for how news *should* be.
