...
content_nl: |
  ...
  **Negatieve differentiatie.** We hebben simpelweg een rijker, gedetailleerder vocabulaire en mentale toolkit voor het negatieve. Meer woorden voor pijn dan voor plezier, meer categorieën voor dingen die misgaan dan voor dingen die goed gaan. Het slechte is fijner in onze hoofden in kaart gebracht.
  ...
  Als Rozin en Royzman de kaart hebben getekend, heeft een tweede belangrijke paper een vlag op die kaart geplant. In hetzelfde jaar publiceerden Roy Baumeister en collega's een uitgebreide review met een titel die het gewoon helder zegt: ["Slecht is Sterker dan Goed"](https://journals.sagepub.com/doi/abs/10.1037/1089-2680.5.4.323).
...
content_fr: |
  ...
  ![Une balance où une lourde sphère noire négative l'emporte sur un ensemble de petites sphères positives](/assets/editorials/bad-stronger-hero.svg)
  ...
  La meilleure carte de cela que j'ai rencontrée est un article de 2001 par Paul Rozin et Edward Royzman avec le titre merveilleusement sec ["Negativity Bias, Negativity Dominance, and Contagion"](https://journals.sagepub.com/doi/10.1207/S15327957PSPR0504_2). Ils décomposent le biais en quatre mécanismes distincts, et je pense qu'il vaut la peine de les parcourir, car chacun d'eux correspond presque parfaitement à la façon dont les nouvelles fonctionnent.
  
  ![Quatre mécanismes du biais de négativité : puissance négative, gradients négatifs plus raides, dominance de la négativité et différenciation négative](/assets/editorials/four-mechanisms.svg)
  ...
  **Différenciation négative.** Nous avons simplement un vocabulaire et une boîte à outils mentale plus riches et plus détaillés pour le négatif. Plus de mots pour la douleur que pour le plaisir, plus de catégories pour les choses qui vont mal que pour celles qui vont bien. Le mauvais est plus finement cartographié dans nos têtes.
  ...
  Si Rozin et Royzman ont dessiné la carte, un deuxième article marquant a planté un drapeau dessus. La même année, Roy Baumeister et ses collègues ont publié une revue exhaustive avec un titre qui le dit simplement : ["Bad Is Stronger Than Good"](https://journals.sagepub.com/doi/abs/10.1037/1089-2680.5.4.323).
...
![A balance scale where one heavy dark negative sphere outweighs a whole cluster of smaller positive ones](/assets/editorials/bad-stronger-hero.svg)
...
The best map of this I've come across is a 2001 paper by Paul Rozin and Edward Royzman with the wonderfully dry title ["Negativity Bias, Negativity Dominance, and Contagion"](https://journals.sagepub.com/doi/10.1207/S15327957PSPR0504_2). They break the bias down into four distinct mechanisms, and I think they're worth walking through, because each one maps almost perfectly onto how news works.

![Four mechanisms of negativity bias: negative potency, steeper negative gradients, negativity dominance, and negative differentiation](/assets/editorials/four-mechanisms.svg)
...
If Rozin and Royzman drew the map, a second landmark paper planted a flag on it. In the same year, Roy Baumeister and colleagues published a sweeping review with a title that just says it plainly: ["Bad Is Stronger Than Good"](https://journals.sagepub.com/doi/abs/10.1037/1089-2680.5.4.323).
