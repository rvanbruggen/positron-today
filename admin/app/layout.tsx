  ...
  return (
    <html lang="en">
      <body className={`${geist.className} bg-amber-50 min-h-screen flex flex-col`}>
        <nav className="bg-yellow-400 shadow-sm relative">
          <div className="max-w-screen-2xl mx-auto px-4 py-3 flex items-center gap-4 md:gap-6">
            <Link href="/" className="flex items-center gap-2 text-xl font-bold text-amber-900 tracking-tight shrink-0">
              ...
              <span className="hidden sm:inline">Positron Today</span>
            </Link>
            <span className="text-amber-700 text-sm font-medium hidden sm:inline">admin</span>
            ...
            <div className="ml-auto flex items-center gap-2 md:gap-3">
              ...
              <a
                ...
                className="text-xs bg-amber-900 text-yellow-300 px-3 py-1.5 rounded-lg hover:bg-amber-800 transition-colors font-medium hidden md:inline-block"
              >
                View site ↗
              </a>
            </div>
        ...
        <main className="max-w-screen-2xl mx-auto px-4 py-6 md:py-8 flex-1 w-full">
          {children}
        </main>
